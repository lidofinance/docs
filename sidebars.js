  ...
  docs: [
    ...
    },
    {
      ...
      items: [
          ...
          items: [
            ...
            { type: 'doc', id: 'staking-modules/csm/permissions', label: 'Permissions' },
            {
              ...
              items: [
                ...
                'staking-modules/csm/contracts/Verifier',
                'staking-modules/csm/contracts/Ejector',
                'staking-modules/csm/contracts/ExitPenalties',
                'staking-modules/csm/contracts/ParametersRegistry',
                'staking-modules/csm/contracts/ValidatorStrikes',
                'staking-modules/csm/contracts/PermissionlessGate',
                'staking-modules/csm/contracts/VettedGate',
                'staking-modules/csm/contracts/MerkleGateFactory',
              ],
            },
        ...
        {
          type: 'category',
          label: 'Curated Module v2',
          link: { type: 'doc', id: 'staking-modules/cm-v2/intro' },
          items: [
            'staking-modules/cm-v2/intro',
            { type: 'doc', id: 'staking-modules/cm-v2/permissions', label: 'Permissions' },
            {
              type: 'category',
              label: 'Contracts',
              items: [
                'staking-modules/cm-v2/contracts/CuratedModule',
                'staking-modules/cm-v2/contracts/MetaRegistry',
                'staking-modules/cm-v2/contracts/Accounting',
                'staking-modules/cm-v2/contracts/Ejector',
                'staking-modules/cm-v2/contracts/ExitPenalties',
                'staking-modules/cm-v2/contracts/FeeDistributor',
                'staking-modules/cm-v2/contracts/FeeOracle',
                'staking-modules/cm-v2/contracts/CuratedGate',
                'staking-modules/cm-v2/contracts/MerkleGateFactory',
                'staking-modules/cm-v2/contracts/ParametersRegistry',
                'staking-modules/cm-v2/contracts/ValidatorStrikes',
                'staking-modules/cm-v2/contracts/Verifier',
              ],
            },
          ],
        },
