...
> ✂️ Both Lido on Kusama and Polkadot are [undergoing sunsetting stage](https://mixbytes.io/blog/mixbytes-sunsets-lido-on-polkadot-and-kusama).
> New stake deposits are disabled. Official termination is [scheduled](https://mixbytes.io/blog/mixbytes-sunsets-lido-on-polkadot-and-kusama#rec563434649) on 2023-08-01.
...
Please refer to the [API doc page](/integrations/api#simple-moving-average-lido-apr-for-7-last-day) for further details.
