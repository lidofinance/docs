...
:::tip 📘 **Lido V3 Technical Paper — Now Available**

Discover **stVaults** — a new primitive that enables staking through user-defined validator setups with optional stETH liquidity. Read the [**Lido V3 Technical Paper**](/lido-v3-whitepaper) to learn how Lido V3 resolves the control-versus-liquidity dilemma in Ethereum staking.

:::

&emsp;📘 Read the [Lido V3 Technical Paper](/lido-v3-whitepaper) — stVaults and the future of liquid staking
