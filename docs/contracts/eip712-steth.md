...
- [Source code](https://github.com/lidofinance/core/blob/v3.1.0/contracts/0.8.9/EIP712StETH.sol)
...
For a specific use case, see the [StETHPermit.permit()](https://github.com/lidofinance/core/blob/v3.1.0/contracts/0.4.24/StETHPermit.sol#L99-L112) implementation.
