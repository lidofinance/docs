...
- [Source code](https://github.com/lidofinance/core/blob/v4.0.0/contracts/0.8.25/vaults/predeposit_guarantee/PredepositGuarantee.sol)
...
- [PDG guide](/run-on-lido/stvaults/node-operators/basic-stvaults/pdg)
