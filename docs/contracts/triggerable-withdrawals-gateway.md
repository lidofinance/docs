...
- [Source code](https://github.com/lidofinance/core/blob/v3.1.0/contracts/0.8.9/TriggerableWithdrawalsGateway.sol)
...
To engage Emergency Brakes and unpause if required, it inherits from `PausableContract` (see [CircuitBreaker](/contracts/circuit-breaker)).
