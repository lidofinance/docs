...
|-------|----------|------|--------|
| Pause protocol | `stop()` | `PAUSE_ROLE` | Unassigned |
| Resume protocol | `resume()` | `RESUME_ROLE` | Unassigned |
...
GateSeal pauses are time-limited; resuming requires the `RESUME_ROLE` holder (Reseal Manager).

## Accounting and oracles

| Lever | Contract | Mutators | Role | Holder |
|-------|----------|----------|------|--------|
| Consensus settings | AccountingOracle | `setConsensusVersion()`, `setConsensusContract()` | `MANAGE_CONSENSUS_VERSION_ROLE`, `MANAGE_CONSENSUS_CONTRACT_ROLE` | Unassigned |
| Oracle report bounds | OracleReportSanityChecker | Various limit setters | `ALL_LIMITS_MANAGER_ROLE` | Unassigned |
| LazyOracle sanity | LazyOracle | `updateSanityParams()` | `UPDATE_SANITY_PARAMS_ROLE` | Unassigned |
| Oracle daemon config | OracleDaemonConfig | `setConfig()` | `CONFIG_MANAGER_ROLE` | Unassigned |
| VEB report hash submission | ValidatorsExitBusOracle | `submitReportHash()` | `SUBMIT_REPORT_HASH_ROLE` | [`0xFE5986E06210aC1eCC1aDCafc0cc7f8D63B3F977`](https://etherscan.io/address/0xFE5986E06210aC1eCC1aDCafc0cc7f8D63B3F977) |
...
| Lever | Mutators | Role | Holder |
|-------|----------|------|--------|
| Module registry | `addStakingModule()`, `updateStakingModule()`, `setStakingModuleStatus()` | `STAKING_MODULE_MANAGE_ROLE` | [`0x3e40D73EB977Dc6a537aF587D48316feE66E9C8c`](https://etherscan.io/address/0x3e40D73EB977Dc6a537aF587D48316feE66E9C8c) |
| Module fees | `setStakingModuleFees()` | `STAKING_MODULE_MANAGE_ROLE` | [`0x3e40D73EB977Dc6a537aF587D48316feE66E9C8c`](https://etherscan.io/address/0x3e40D73EB977Dc6a537aF587D48316feE66E9C8c) |
| Withdrawal credentials | `setWithdrawalCredentials()` | `MANAGE_WITHDRAWAL_CREDENTIALS_ROLE` | Unassigned |
| Module unvetting | `decreaseStakingModuleVettedKeysCountByNodeOperator()` | `STAKING_MODULE_UNVETTING_ROLE` | [`0xfFA96D84dEF2EA035c7AB153D8B991128e3d72fD`](https://etherscan.io/address/0xfFA96D84dEF2EA035c7AB153D8B991128e3d72fD) |
...
| Lever | Mutators | Role | Holder |
|-------|----------|------|--------|
| Pause | `pauseFor()` | `PAUSE_ROLE` | [`0x8A854C4E750CDf24f138f34A9061b2f556066912`](https://etherscan.io/address/0x8A854C4E750CDf24f138f34A9061b2f556066912), [`0x7914b5a1539b97Bd0bbd155757F25FD79A522d24`](https://etherscan.io/address/0x7914b5a1539b97Bd0bbd155757F25FD79A522d24) |
| Resume | `resume()` | `RESUME_ROLE` | [`0x7914b5a1539b97Bd0bbd155757F25FD79A522d24`](https://etherscan.io/address/0x7914b5a1539b97Bd0bbd155757F25FD79A522d24) |
...
| Lever | Mutators | Role | Holder |
|-------|----------|------|--------|
| Vault connections | `connectVault()`, `updateConnection()`, `disconnect()` | `VAULT_MASTER_ROLE` | Unassigned |
| Redemptions | `setLiabilitySharesTarget()` | `REDEMPTION_MASTER_ROLE` | Unassigned |
| Bad debt handling | `socializeBadDebt()`, `internalizeBadDebt()` | `BAD_DEBT_MASTER_ROLE` | [`0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27`](https://etherscan.io/address/0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27) |
| Forced exits | `forceValidatorExit()` | `VALIDATOR_EXIT_ROLE` | [`0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27`](https://etherscan.io/address/0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27) |
| Pause | `pauseFor()` | `PAUSE_ROLE` | [`0x881dAd714679A6FeaA636446A0499101375A365c`](https://etherscan.io/address/0x881dAd714679A6FeaA636446A0499101375A365c), [`0x7914b5a1539b97Bd0bbd155757F25FD79A522d24`](https://etherscan.io/address/0x7914b5a1539b97Bd0bbd155757F25FD79A522d24) |
| Resume | `resume()` | `RESUME_ROLE` | [`0x7914b5a1539b97Bd0bbd155757F25FD79A522d24`](https://etherscan.io/address/0x7914b5a1539b97Bd0bbd155757F25FD79A522d24) |
...
| Lever | Mutators | Role | Holder |
|-------|----------|------|--------|
| Group registration | `registerGroup()`, `updateGroupShareLimit()` | `REGISTRY_ROLE` | [`0xFE5986E06210aC1eCC1aDCafc0cc7f8D63B3F977`](https://etherscan.io/address/0xFE5986E06210aC1eCC1aDCafc0cc7f8D63B3F977), [`0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27`](https://etherscan.io/address/0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27) |
| Tier management | `registerTiers()`, `alterTiers()` | `REGISTRY_ROLE` | [`0xFE5986E06210aC1eCC1aDCafc0cc7f8D63B3F977`](https://etherscan.io/address/0xFE5986E06210aC1eCC1aDCafc0cc7f8D63B3F977), [`0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27`](https://etherscan.io/address/0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27) |
| Vault fees | `updateVaultFees()` | `REGISTRY_ROLE` | [`0xFE5986E06210aC1eCC1aDCafc0cc7f8D63B3F977`](https://etherscan.io/address/0xFE5986E06210aC1eCC1aDCafc0cc7f8D63B3F977), [`0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27`](https://etherscan.io/address/0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27) |
| Jail status | `setVaultJailStatus()` | `REGISTRY_ROLE` | [`0xFE5986E06210aC1eCC1aDCafc0cc7f8D63B3F977`](https://etherscan.io/address/0xFE5986E06210aC1eCC1aDCafc0cc7f8D63B3F977), [`0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27`](https://etherscan.io/address/0x28F9Ac198C4E0FA6A9Ad2c2f97CB38F1A3120f27) |
## Dual Governance
