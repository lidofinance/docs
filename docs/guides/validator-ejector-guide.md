...
It is highly advised that after exit message are generated and signed, they should be encrypted for storage safety. Ejector will unencrypt files on start by looking up the password in `MESSAGES_PASSWORD` environment variable.
