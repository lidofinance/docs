...
With withdrawals enabled, the APR calculation method for Lido has changed significantly.
...
Please refer to [this page](https://docs.lido.fi/integrations/api/#last-lido-apr-for-steth) for V2 APR calculation. 
