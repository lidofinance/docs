...
| Module | Mainnet |
| --- | --- |
| CMv2 | [`0x004aFb7DAA7dEA20EbAaB75c9F4892C879FaCCe0`](https://etherscan.io/address/0x004aFb7DAA7dEA20EbAaB75c9F4892C879FaCCe0) |
| CSM | [`0x06cd61045f958A209a0f8D746e103eCc625f4193`](https://etherscan.io/address/0x06cd61045f958A209a0f8D746e103eCc625f4193) |
...
- a bad-performance penalty reported by [`ValidatorStrikes`](/staking-modules/contracts/ValidatorStrikes);
- the execution-layer withdrawal request fee paid for a non-voluntary triggered exit.

Applicable amounts and limits are obtained from [`ParametersRegistry`](/staking-modules/contracts/ParametersRegistry) for the Node Operator's bond curve. When a validator withdrawal is processed, the module contract ([`CuratedModule`](/staking-modules/contracts/CuratedModule) or [`CSModule`](/staking-modules/contracts/CSModule)) applies the relevant penalties and charges to the Node Operator's bond through [`Accounting`](/staking-modules/contracts/Accounting).
