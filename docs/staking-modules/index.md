...
- **Rewards.** Node Operator rewards are allocated by a Performance Oracle over 28-day frames and published in a cumulative Merkle tree, on top of the bond rebase. See [Rewards](/staking-modules/rewards).
