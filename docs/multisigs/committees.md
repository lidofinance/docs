...
### 2.8.2 Liquidity Observation Lab Committee (Optimism)
...
### 2.8.3 Liquidity Observation Lab Committee OP Token Multisig
...
### 2.8.4 Liquidity Observation Lab Committee (Arbitrum)
...
### 2.8.6 Liquidity Observation Lab Committee (Polygon)
...
### 2.8.7 Liquidity Observation Lab Committee (Base)
...
### 2.8.8 Liquidity Observation Lab Committee (zkSync Era)
...
### 2.8.9 Liquidity Observation Lab Committee (BNB)
...
### 2.8.10 Liquidity Observation Lab Committee (Linea)
...
### 2.8.12 Liquidity Observation Lab Committee multisigs to distribute AAVE rewards
...
**Purpose of the multisig:** A family of five multisigs with the same address on five networks is set up to receive assets from the Liquidity Observation Lab Committee multisigs on respective networks and distribute them between other approved recipients.
