...
- **LOL (ex.reWARDS) stETH** (committee ms [``](https://app.safe.global/eth:/home))
  - AllowedRecipientsRegistry: [``](https://etherscan.io/address/)
  - AddAllowedRecipient: [``](https://etherscan.io/address/)
  - RemoveAllowedRecipient: [``](https://etherscan.io/address/)
  - TopUpAllowedRecipients: [``](https://etherscan.io/address/)
...
- **RCC stablecoins** (committee ms [``](https://app.safe.global/eth:/home))
  - AllowedRecipientsRegistry: [``](https://etherscan.io/address/)
  - TopUpAllowedRecipients (Proposed to remove): [``](https://etherscan.io//0x84f74733ede9bFD53c1B3Ea96338867C94EC313e)
  - AllowedTokensRegistry (Proposed): [``](https://etherscan.io/address/#code)
  - TopUpAllowedRecipients (Proposed): [``](https://etherscan.io/address/)
- **PML stablecoins** (committee ms [``](https://app.safe.global/eth:/home))
  - AllowedRecipientsRegistry: [``](https://etherscan.io/address/)
  - TopUpAllowedRecipients (Proposed to remove): [``](https://etherscan.io/address/)
  - AllowedTokensRegistry (Proposed): [``](https://etherscan.io/address/#code)
  - TopUpAllowedRecipients (Proposed): [``](https://etherscan.io/address/)
