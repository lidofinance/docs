...
: "${BASIC_AUTH_PARTNER_USER:?BASIC_AUTH_PARTNER_USER env var is required}"
: "${BASIC_AUTH_PARTNER_PASS:?BASIC_AUTH_PARTNER_PASS env var is required}"

printf '%s' "$BASIC_AUTH_PASS" | htpasswd -ci /tmp/.htpasswd "$BASIC_AUTH_USER"

printf '%s' "$BASIC_AUTH_PARTNER_PASS" | htpasswd -bi /tmp/.htpasswd "$BASIC_AUTH_PARTNER_USER"
