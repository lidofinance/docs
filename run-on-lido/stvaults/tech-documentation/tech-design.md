...
3. Other risks. Regulatory and other risks could be found in [Public Risk Disclosure](https://docs.lido.fi/security/prd).
...
- [Public Risk Disclosure](https://docs.lido.fi/security/prd)
