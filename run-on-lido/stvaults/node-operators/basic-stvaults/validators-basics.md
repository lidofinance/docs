...
For validators that already exist elsewhere, [consolidation](./consolidation.md) migrates them into an stVault instead of exiting and redepositing.
...
- [Consolidations](./consolidation.md) — migrating existing validators into an stVault
