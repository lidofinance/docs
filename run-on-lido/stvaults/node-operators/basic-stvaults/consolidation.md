---
sidebar_position: 6
title: Consolidation running validators to stVaults
sidebar_label: Consolidation to stVaults
---
...
For detailed CLI options, see [stVault operations documentation](https://lidofinance.github.io/lido-staking-vault-cli/commands/vault-operations#role-grant).
...
Input data is checked twice: off-chain by the CLI and on-chain by the [`ValidatorConsolidationRequests`](/contracts/validator-consolidation-requests) contract, which also builds the final calldata itself rather than accepting it from the caller.
...
For detailed CLI options, see [stVault operations documentation](https://lidofinance.github.io/lido-staking-vault-cli/commands/vault-operations#role-revoke).
