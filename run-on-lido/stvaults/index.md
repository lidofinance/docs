---
title: stVaults Documentation Center
sidebar_label: stVaults Documentation Center
sidebar_position: 3
description: Navigation hub for everything related to Lido V3 stVaults — product overview, guides by role, and tools.
---
...
| --- | --- |
| 🛠️ [Builders](./builders/) | Teams building a product on top of stVaults — DeFi integrations, wrappers, L2s, custom staking products. |
| 🏦 [Vault Owners, Curators & Stakers](./vault-owners-curators-and-stakers/) | Anyone operating or managing an stVault: funding, minting, health monitoring, roles and permissions. |
| ⚙️ [Node Operators](./node-operators/) | Node operators running validators for stVaults — onboarding, tiers, requirements. |
...
| 🔍 [V3 Audits](./concepts-and-reference/audits.md) | Security audit reports for stVaults and DeFi Wrapper. |
...
| Tool | Link |
| --- | --- |
| Web UI — Mainnet | [stvaults.lido.fi](https://stvaults.lido.fi/) |
| Web UI — Hoodi Testnet | [stvaults-hoodi.testnet.fi](https://stvaults-hoodi.testnet.fi/) |
| Command-line interface (CLI) | [CLI Docs](https://lidofinance.github.io/lido-staking-vault-cli/) |