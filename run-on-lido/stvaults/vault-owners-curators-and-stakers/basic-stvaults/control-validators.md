---
sidebar_position: 6
title: Control Validators and Withdraw ETH from the Beacon Chain
sidebar_label: Control Validators

---

# Control Validators and Withdraw ETH from the Beacon Chain
...
- the ETH needed to bring the Health Factor back above 100%, or the ETH needed to cover pending [Lido redemptions](../../concepts-and-reference/stvaults-technical-design.md#2-redemptions) — whichever of the two is larger;
