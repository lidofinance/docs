...
3. [Rebalance](./basic-stvaults/rebalance.md) — simultaneously reducing the stVault's Total Value and stETH Liability together, 1:1.
4. [Control Validators and Withdraw ETH from the Beacon Chain](./basic-stvaults/control-validators.md) — exiting validators, partially withdrawing ETH from validators, and pausing new deposits.
...
2. [Stakers' Emergency Guide](./defi-wrapper/stakers/emergency-guide.md) — withdrawing ETH from a non-responsive stVault with DeFi Wrapper.