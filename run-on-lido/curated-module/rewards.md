...
- The percentage depends on your operator type and applies uniformly to all your keys within the same sub-NO (see [Node Operator Types](./node-operator-types)).
...
- `Accounting.sol` pulls your portion of fees from `FeeDistributor.sol` and combines it with your claimable bond balance
