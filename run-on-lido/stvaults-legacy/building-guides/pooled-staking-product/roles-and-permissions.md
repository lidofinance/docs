...
This page describes **DeFi Wrapper-specific roles** for pooled staking products. For **stVaults roles**, see [stVaults Roles and permissions](/run-on-lido/stvaults-legacy/features-and-mechanics/roles-and-permissions).
