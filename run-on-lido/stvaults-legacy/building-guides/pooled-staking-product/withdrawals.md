...
For role/permission boundaries between Vault Owner vs Node Operator actions, see [stVaults Roles and permissions](/run-on-lido/stvaults-legacy/features-and-mechanics/roles-and-permissions).
