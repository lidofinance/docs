...
For a comprehensive understanding of stVaults architecture, mechanisms, and the vision behind Lido V3, read the official [**Lido V3 Technical Paper**](/run-on-lido/stvaults-legacy/concepts-and-reference/lido-v3-whitepaper) with embedded PDF preview.
...
| [End-user staking product by DeFi Wrapper](./building-guides/pooled-staking-product/) | A DeFi-wrapped stVault with pooling, liquidity, automated yield-boosting strategy, and white-labeled staking UI – all in one customizable no-code/low-code solution. | Retail stakers (&lt;32 ETH), APR-maximizers, institutional stakers seeking a simple staking UI. |
...
1. [📘 **Lido V3 Technical Paper**](/run-on-lido/stvaults-legacy/concepts-and-reference/lido-v3-whitepaper) — Complete technical specification with PDF preview
...
5. [Applying Oracle Reports](./operational-and-management-guides/applying-report-guide.md)
...
1. [stVaults Integration Overview](./tech-documentation/integration-overview.md)
2. [stVaults Technical Design](./tech-documentation/tech-design.md)
