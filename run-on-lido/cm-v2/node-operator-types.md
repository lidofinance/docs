...
In Phase 2, Validator Market (ValMart) is expected to make stake allocation weight more dynamic. Effective weight may also factor in your custom fee, operator type, current strike count, any additional stETH bond you hold voluntarily, and any LDO you have locked or delegated. This means Node Operators may be able to increase the weight of an individual sub-NO, and therefore the total effective weight of the group.
