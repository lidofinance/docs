...
| [Staking Modules Documentation](/staking-modules/) | Contracts and detailed specifications shared by CSM and CMv2. For advanced users. |
| [CSM Context & Background](./context-and-background) | Understand CSM, the difference between the `0x01` module (live on Mainnet) and the `0x02` module (live on testnet), and the operator profiles available in each. |
...
| [Lido Discord](https://discord.com/invite/lido) | Get support in the `csm-mainnet` and `csm-testnet` channels. |
