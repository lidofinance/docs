...
If you need extra help, join the [Lido Discord](https://discord.gg/lido), and get support from `@eenti` or `@community-validator-support` in the csm-mainnet and csm-testnet channels.
