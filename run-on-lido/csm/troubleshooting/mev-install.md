...
![MEV relays selected by Eth Docker](/img/csm-guide/eth-docker-mev-relays.png)
...
![COMPOSE_FILE line with mev-boost.yml](/img/csm-guide/eth-docker-compose-file.png)
...
The node setup itself is covered under [Systemd](/run-on-lido/csm/node-setup/advanced/systemd).
...
The MEV Boost setup steps are covered under [Ethereum on ARM](/run-on-lido/csm/node-setup/advanced/ethereum-on-arm).
